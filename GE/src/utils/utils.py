...
init_metric_dict = {'metric/best_clf_epoch': 0, 'metric/best_clf_valid_loss': 0,
                    ...
                    'metric/best_x_precision_train': 0, 'metric/best_x_precision_valid': 0,
                    'metric/best_x_precision_test': 0}
...
def visualize_a_graph(edge_index, edge_att, node_label, dataset_name, coor=None, norm=False, mol_type=None,
    ...
    nx.draw_networkx_edges(G, pos, width=0.5, edge_color='gray', arrows=False, alpha=0.1, ax=ax)
